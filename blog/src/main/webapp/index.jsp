...
<head>
    ...
    <link rel="shortcut icon" href="<%=basePath%>static/images/logo.ico">
    <title>简单的博客系统</title>
    ...
    <script src="<%=basePath%>static/js/jquery-ui-1.9.2.custom.min.js"></script>
    <style type="text/css">
        body {
    ...
    <header class="header black-bg">
        <div class="sidebar-toggle-box">
            <div class="fa fa-bars tooltips" data-placement="right" data-original-title="Toggle Navigation">
                <img src="static/images/logo.ico" height="30px" width="30px">
            </div>
        </div>
        <!--logo start-->
    ...
    <aside>
        <div id="sidebar" class="nav-collapse scrollable">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li>
                    <img src="<%=basePath%>static/images/touxiang.jpg" height="180px" width="180px">
